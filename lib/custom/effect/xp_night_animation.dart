...
class XpNightAnimation extends StatefulWidget {
  final int xp;

  const XpNightAnimation({super.key, required this.xp});

  @override
  State<XpNightAnimation> createState() => _XpNightAnimationState();
}

class _XpNightAnimationState extends State<XpNightAnimation> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        // 은색 원 5개ㅓ
        _buildParticle(angleDeg: 5, distance: 75, size: 25, color: const Color(0xFFD9D9D9)),
        _buildParticle(angleDeg: -20, distance: 82, size: 8, color: const Color(0xFFD9D9D9)),
        _buildParticle(angleDeg: -32, distance: 75, size: 12, color: const Color(0xFFD9D9D9)),
        _buildParticle(angleDeg: 200, distance: 65, size: 16, color: const Color(0xFFD9D9D9)),
        _buildParticle(angleDeg: 135, distance: 77, size: 20, color: const Color(0xFFD9D9D9)),
