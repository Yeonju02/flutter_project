...
class XpNightDialog extends StatefulWidget {
  ...
  @override
  State<XpNightDialog> createState() => _XpNightDialogState();
}

class _XpNightDialogState extends State<XpNightDialog> with TickerProviderStateMixin {
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            XpNightAnimation(xp: widget.earnedXP),
